...
function SandboxPage() {
  ...
  useEffect(() => {
    ...
    document.title = 'Skin Lesion Removal Southampton | RHI Aesthetics | Sandbox';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative z-10 hidden lg:grid lg:grid-cols-2 lg:gap-8 w-full max-w-7xl mx-auto px-6 lg:px-12 py-24">
          ...
          >
            ...
            {/* Social proof alongside Calendly - Desktop */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.6 }}
              className="flex items-center gap-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 max-w-md"
            >
              <div className="w-16 h-16 rounded-full bg-teal-200 flex-shrink-0 overflow-hidden border-2 border-white/40">
                {/* Placeholder image - replace with real client photo */}
              ...
              <div>
                ...
                <p className="text-white/90 text-sm font-light leading-snug">
                  "Can't believe I waited so long. Completely painless and healed beautifully!"
                </p>
                <p className="text-white/60 text-xs font-light mt-1">Lauren M. — 3 weeks ago</p>
              </div>
            </motion.div>
          </motion.div>
      ...
      <section id="mobile-booking" className="bg-white py-16 lg:hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          {/* Social proof - Mobile (compact strip above Calendly) */}
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="flex items-center gap-3 bg-teal-50 border border-teal-200 rounded-xl p-3 mb-6"
          >
            <div className="w-12 h-12 rounded-full bg-teal-200 flex-shrink-0 overflow-hidden border-2 border-teal-300">
              {/* Placeholder image - replace with real client photo */}
              <div className="w-full h-full bg-gradient-to-br from-teal-300 to-teal-500 flex items-center justify-center">
            ...
            <div className="min-w-0">
              ...
              <p className="text-gray-700 text-xs font-light leading-snug">
                "Completely painless and healed beautifully!" — Lauren M.
              </p>
            </div>
          </motion.div>
      ...
      {/* NOT READY YET? CALL/MESSAGE SECTION */}
      <section className="py-12 px-6 bg-gradient-to-br from-teal-50 to-white border-y border-teal-100">
        <div className="max-w-3xl mx-auto">
          ...
          >
            <div className="flex items-center justify-center gap-3">
              ...
              <h2 className="font-serif text-2xl sm:text-3xl text-gray-900 font-light">
                Not ready to book yet?
              </h2>
            </div>
            <p className="text-base text-gray-600 font-light leading-relaxed max-w-xl mx-auto">
              No pressure at all. If you have questions, concerns, or just want to chat about your options first, I'm here for you.
            </p>
            <motion.a
              href="https://wa.me/447307762776"
              target="_blank"
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-3 px-8 py-4 bg-teal-600 text-white text-sm tracking-widest uppercase font-light hover:bg-teal-700 transition-all duration-200 shadow-lg shadow-teal-500/20 rounded-md"
            >
              <MessageCircle className="w-5 h-5" />
              Call / Message Me With Your Concerns
            </motion.a>
            <p className="text-xs text-gray-500 font-light">
              WhatsApp or call — I usually reply within a few hours
            </p>
          </motion.div>
        </div>
      </section>
