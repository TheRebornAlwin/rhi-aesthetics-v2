...
function HampshireSkinLesionRemovalPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional skin lesion removal in the Hampshire County area. Serving Southampton, Portsmouth, Winchester, Basingstoke & beyond. Safe mole and skin tag removal with minimal scarring. Expert care, natural results, £49 intro offer.');
    }
    ...
    setMetaTag('og:title', 'Skin Lesion Removal Hampshire | RHI Aesthetics');
    setMetaTag('og:description', 'Professional skin lesion removal in the Hampshire County area. Serving Southampton, Portsmouth, Winchester & beyond. Safe mole and skin tag removal, £49 intro offer.');
    ...
    setTwitterTag('twitter:title', 'Skin Lesion Removal Hampshire | RHI Aesthetics');
    setTwitterTag('twitter:description', 'Professional skin lesion removal in the Hampshire County area. Serving Southampton, Portsmouth, Winchester & beyond.');
        ...
        >
          ...
          >
            ...
            <p className="text-xl sm:text-2xl text-white leading-relaxed max-w-3xl mx-auto font-light">
              Safe, professional skin lesion removal across the Hampshire County area with minimal scarring and natural results.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light leading-relaxed">
              Every treatment performed with precision and care for clients across the Hampshire County area. These are real clients, real results.
            </p>
          </motion.div>
      ...
      <section id="stories" className="py-24 lg:py-32 px-6 bg-gradient-to-br from-teal-50/30 to-white">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto font-light leading-relaxed">
              Real women from across Hampshire who finally felt free
            </p>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-12 mb-12">
            <div className="space-y-6">
              ...
              <p className="text-sm text-teal-100 font-light leading-relaxed">
                Professional skin lesion removal across the Hampshire County area
              </p>
...
export default HampshireSkinLesionRemovalPage;
