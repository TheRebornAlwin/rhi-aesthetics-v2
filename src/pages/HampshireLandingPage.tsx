...
function HampshireLandingPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Professional skin lesion removal in Hampshire. Precise 60-minute treatment. Mole, wart, and skin lesion removal with natural results. £49 intro offer.');
    }
